package qin.javaee65.core.hibernate.dao;

import org.springframework.orm.hibernate4.HibernateOperations;
import qin.javaee65.core.ClassSupport;
import qin.javaee65.core.JavaEE65PrintSupport;
...
public interface JavaEE65DAOSupport<T, ID extends Serializable>
          extends ClassSupport<T>, HibernateOperations, JavaEE65PrintSupport
{
    //region 增
     ...
     * @since 6.5
     */
    <E> List<?> findByEntity(T entity, E elements);
    //endregion
}
